...
function MinibatcherFromFileList:__init(fileList,batchSize,cuda,preprocess,shuffle,lazyCuda,numRowsToGPU)
	...
	for file in io.lines(fileList) do
		local batch  = MinibatcherFromFile(file,batchSize,cuda,shuffle,lazyCuda,numRowsToGPU)
